             ...
             @foreach($post as $key => $val)
                ...
                <div class="single-products" style="margin: 10px 0px">
                        <div class="productinfo text-center">
                                    ...
                                    <img style="width:30% ; float: left; padding: 5px" src="{{URL::to('public/uploads/post/'.$val->post_image)}}" alt="{{$val->post_slug}}" />

                                    <h4 style="color: #000; padding: 5px">{{ $val->post_title}}</h4>
                                    <p>{{$val->post_desc}}</p>


                                <a href="{{URL::to('bai-viet/'.$val->post_slug)}}" class="btn btn-success btn-sm">Xem bài viết</a>
