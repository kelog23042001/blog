            ...
            <table class="table table-striped b-t b-light">
                ...
                <tbody>
                    ...
                    <tr class="color_qty_{{$details->product->product_id}}" )>
                        ...
                        <td>
                            <input type="number" {{$order_status != 1 ?'disabled' : ''}} class="order_qty_{{$details->product_id}}" max="{{$details->product->product_quantity}}" min="1" value="{{$details->product_sale_quantity}}" name="product_sales_quantity" id="order_qty_view_order">

                            <!-- <input type="hidden" id="order_product_id" value="{{$details->product_id}}"> -->

                            <input type="hidden" id="order_qty_storage_{{$details->product_id}}" name="order_qty_storage" class="order_qty_storage_{{$details->product_id}}" value="{{$details->product->product_quantity}}">
