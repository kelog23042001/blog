                ...
                <table class="table table-striped" id="table-category">
                        ...
                        <form>
                            ...
                            <tr id="sid{{$user->id}}">
                                ...
                                <td>
                                    ...
                                    <select class="dataTable form-select" name="role" id="role_{{$user->id}}"
                                        onchange="update_role({{$user->id}});">
                                ...
                                <td  style="text-align: center;">
                                    ...
                                    <span><a  onclick="delete_user({{$user->id}})" style="font-size: 20px;"
                                        class="active styling-edit" ui-toggle-class=""><i class="bi bi-trash"></i></a></span>
                                </td>
                            </tr>
                        </form>
                        @endforeach
                    ...
                    <script>
                        function delete_user(id) {
                            ...
                            if (confirm('Bạn có muốn xoá người dùng?')) {
                                $.ajaxSetup({
                                    headers: {
