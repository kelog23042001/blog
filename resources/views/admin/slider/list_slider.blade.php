                  ...
                  <input type="checkbox"><i></i>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{URL::to('/edit-slider/'.$slide->slider_id)}}" style="font-size: 20px;" class="active styling-edit" ui-toggle-class=""><i class="bi bi-eyedropper"></i></i></a>
                                <a onclick="return confirm('Bạn có chắc chắn muốn xoá?')" href="{{URL::to('/delete-slider/'.$slide->slider_id)}}" style="font-size: 20px;"><i class="bi bi-trash"></i></a>
                            </td>
